...
TERMINAL_CELL_SIZE_X = 12
TERMINAL_CELL_SIZE_Y = 24
...
MESSAGE_PANEL_X = 2
MESSAGE_PANEL_W = TERMINAL_SIZE_X - 4
MESSAGE_PANEL_H = 7
MESSAGE_PANEL_Y = TERMINAL_SIZE_Y - MESSAGE_PANEL_H - 1
...
STATS_PANEL_W = TERMINAL_SIZE_X - ((MAP_PANEL_W + MAP_PANEL_X) * TERRAIN_SCALE_X) - (2 * TERRAIN_SCALE_X)
STATS_PANEL_X = ((MAP_PANEL_W + MAP_PANEL_X) * TERRAIN_SCALE_X) + 2
